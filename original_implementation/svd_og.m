function [Uini, HH,it, Uout,singvals,Vout] = svd_og(A,a,b,minlen,NS);
...
[Uini,HH,it] = qdwh_og(A,a,b);     % Compute polar decomposition A = UH.
...
[Vout,singvals] = eig_og(HH,normA,minlen,NS); 
